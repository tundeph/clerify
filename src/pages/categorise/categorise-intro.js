...
import { DivWrapper, Text, Card, Divider, Button } from "../../layout/styles"
    ...
    <DivWrapper max="s">
      <Card>
        ...
        <Text size={size.xxs} bottom={1}>
          You can reconcile all your transactions by categorising few of them
          and then allowing the app to do the rest for you
        </Text>
        <Divider />
        <Text bottom={1}>
