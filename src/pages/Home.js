      ...
      <UserWrapper>
        ...
        <SplitDiv minWidth={200} top={3} gap={4}>
          <DivWrapper top={5} gap={3}>
            ...
            <SubTitle>
              Categorize millions of financial transactions with accuracy, in a breeze. Your
              financial statements are no longer a burden
            </SubTitle>
            <Divider />
          </DivWrapper>
          <DivWrapper>
        ...
        <SplitDiv minWidth={200} top={3} gap={4}>
          ...
          <DivWrapper top={5} gap={3}>
            <Text size={size.m}> Make better decisions for your business. </Text>
            <SubTitle>
              See how your business is doing- with financial and visual reports in real time. Plot
              charts, compare month-on-month volumes for any category of your transactions in few
              clicks
            </SubTitle>
            <Divider />
          </DivWrapper>
        ...
        <SplitDiv minWidth={200} top={3} gap={4}>
          <DivWrapper top={5} gap={3}>
            ...
            <SubTitle>
              Save time and money with our automated transaction categorization. You'll never have
              to worry about your accounts again
            </SubTitle>
            <Divider />
          </DivWrapper>
          <DivWrapper>
